...
generating probabilistic paths and tables for the Viterbi algorithm.

Currently, there are 2 classes of the Viterbi algorithm:
	* Viterbi: finds path with maximized probability
	* StochasticViterbi: finds all potential paths with probabilities
"""
...
class Parse:
	def __init__(self, score=None, path=None, freq=None, decoder=None):
		...
		----------
		score: float
			Float score comparison between null and path probability
			(default is None)
		path: dictionary
		 	Path of interest (default is None)
		freq: float
			Frequency of path occurring (default is None)
		decoder: object
			Decoder used for parsing (default is None)
		"""
...
class Performance:
	...
	def compare(self, source=None, prediction=None):
		...
		----------
		source: list[object]
			List of source Feature objects (default is None)
		prediction: list[object]
			List of prediction Feature objects (default is None)
		"""
...
class HMM_NT_decoder:
	"""Class for the HMM Nucleotide Decoder"""

	def state_map(self):
		"""
		Make a state map (dictionary).
	...
	def transition_map(self):
		"""
		Make a transition map of the states, going backwards in path.
		"""
...
class Viterbi(HMM_NT_decoder):
	...
	def __init__(self, model=None, dna=None):
		...
		----------
		model: object
			Model generated (default is None)
		dna: object
			DNA information (default is None)
		"""
...
class StochasticViterbi(HMM_NT_decoder):
	...
	def __init__(self, model=None, dna=None, seed=None):
		...
		dna: object
			DNA information (default is None)
		seed: int
			Custom random seed (default is None)
		"""
